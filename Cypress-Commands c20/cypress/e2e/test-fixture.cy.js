...
var mydata  // variale global que guarda los datos obtenidos del archivo
  ...
  it('Test Login Usuario', () => {
    ...
    mydata.forEach((data) =>{  // leo un renglón de los 10 que contiene el json
          // El comando escribir, se encuentra en el archivo commands.js de support y 
          // recibe los parámetros de selector y texto a escribir, además de generar un tiempo
          // de espera de 2 seg.
